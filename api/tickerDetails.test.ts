...
describe('getTickerDetails', () => {
  it('should fetch ticker details successfully with default parameters', async () => {
    ...
    expect(mockedAxios.get).toHaveBeenCalledWith('/reference/tickers/AAPL', { params: {} });
  ...
  it('should fetch ticker details with given parameters', async () => {
    const mockResponse = {
      data: {
        ...
        results: {
          ...
          branding: {
            logo_url: "https://api.polygon.io/v1/reference/company-branding/YXNsdC5jb20/images/2024-06-01_logo.svg",
            icon_url: "https://api.polygon.io/v1/reference/company-branding/YXNsdC5jb20/images/2024-06-01_icon.jpeg"
          },
    ...
    expect(mockedAxios.get).toHaveBeenCalledWith('/reference/tickers/TSLA', { params });
    expect(result).toEqual(mockResponse.data);
  });
