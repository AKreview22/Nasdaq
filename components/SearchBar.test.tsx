...
describe('SearchBar', () => {
  it('renders correctly', () => {
    const { getByPlaceholderText } = render(<SearchBar setSearchQuery={jest.fn()} />);
  ...
  it('calls setSearchQuery and shows arrow on submit', async () => {
    ...
    const { getByPlaceholderText, getByTestId } = render(<SearchBar setSearchQuery={mockSetSearchQuery} />);
    const input = getByPlaceholderText('Search for stocks');
